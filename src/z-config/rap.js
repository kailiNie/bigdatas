...
(function (window, undefined) {
    var node = null;
    var blackList = [];
    var whiteList = ["uis/sheet/query","uis/sheet/detail","uis/sheet/del","uis/sheet/save","uis/sheet/cancel","uis/sheet/check","template/simple-goods","uis/sui-grid-edit/getDoods","common/queryGoods","system/login","/authenticate/login","/business/sms/sendcode","/orgm/user/pwsd/reset","uis/sui-validator/grid","uis/print","uis/custom","uis/supplier","uis/salelist","uis/goods","uis/grouplist","uis/vemlist","uis/sale/detail","standard-ui/master-slave-sheet/query","standard-ui/master-slave-sheet/cancel","standard-ui/master-slave-sheet/copy","standard-ui/master-slave-sheet/check","standard-ui/master-slave-sheet/editcomplete","standard-ui/master-slave-sheet/del","standard-ui/master-slave-sheet/custom1","standard-ui/master-slave-sheet/custom3","standard-ui/master-slave-sheet/custom4","standard-ui/master-slave-sheet/custom2","standard-ui/master-slave-sheet/save","standard-ui/master-slave-sheet/detail","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","api/orgm/org/juniororg/page","api/orgm/stockm/shopm/list","api/orgm/stockm/typelist","api/orgm/stockm/junior/list","api/devicem/group/mylist","api/goods/shop/page","api/orgm/stockm/oprate","api/orgm/stockm/shopm/oprate","api/orgm/stockm/list","api/orgm/stockm/datail","api/orgm/stockm/add","api/orgm/stockm/update","api/storagem/inventory/list","api/stragem/inventory/booklist","api/storagem/inventory/adjust","/api/storagem/pdyk/list","/api/storagem/pdyk/detail","/api/storagem/pdyk/oprate","/api/storagem/pdyk/input/goodslist","/api/storagem/pdyk/input","/api/stragem/pdyk/add","api/storagem/outinput/list","api/storagem/outinput/operate","api/storagem/outinput/detail","api/storagem/outinput/add","api/storagem/outinput/update","api/goods/goods/page/simple","/api/storagem/replenish/add","/api/storagem/replenish/list","/api/storagem/replenish/update","/api/storagem/replenish/operate","/api/storagem/replenish/detail","/api/storagem/replenish/handle","/api/storagem/replenish/handle/list","api/storagem/pick/list","api/storagem/pick/operate","api/storagem/pick/add","api/storagem/pick/detail","api/storagem/pick/update","api/storagem/pick/getdelv","api/storagem/delivery/setoutqty","api/storagem/pick/sheetop","api/storagem/transfer/add","api/storagem/transfer/list","api/storagem/transfer/operate","api/storagem/transfer/update","api/storagem/transfer/detail","api/storagem/purchase/list","api/storagem/purchase/add","api/storagem/purchase/operate","api/storagem/purchase/update","api/storagem/purchase/detail","api/storagem/delivery/add","api/storagem/delivery/list","api/storagem/delivery/operate","api/storagem/delivery/update","api/storagem/delivery/detail","api/storagem/delivery/setoutqty","/transmgr/offrecharge/list/query","/transmgr/offrecharge/info/update","/transmgr/offrecharge/info/del","/transmgr/offrecharge/info/check","/transmgr/offrecharge/info/add","/transmgr/offrecharge/info/get","/acctmgr/acct/info/update","/acctmgr/acct/list/query","/acctmgr/acct/info/get","acctmgr/subacct/list/query","acctmgr/acct/cust/list/query","acctmgr/subacct/info/get","acctmgr/subacct/status/stop","acctmgr/subacct/status/start","transmgr/transferacct/info/add","acctmgr/subacct/running/list","basicdata/subacct/predefine/list","common/menu/get","/transmgr/offwithdraw/list/query","/transmgr/offwithdraw/info/add","/transmgr/offwithdraw/info/update","/transmgr/offwithdraw/info/del","/transmgr/offwithdraw/info/check","/transmgr/offwithdraw/info/get","/transmgr/offwithdraw/cfginfo/get","api/system/user/select-user","/api/orgm/module/list","api/orgm/base/customer/query","api/orgm/base/vender/query","api/salem/payaccountm/list","api/salem/payaccountm/add)","api/salem/payaccountm/update","api/salem/payaccountm/shop/update","api/salem/payaccountm/paytype/update","api/salem/payaccountm/operate","api/salem/payaccountm/setdefault","api/salem/payaccountm/cert/upload","api/salem/payaccountm/sms/send","api/salem/payaccountm/sms/check","api/salem/payaccountm/org","api/salem/payaccountm/paytype/add"];

    var ROOT = "192.168.20.72:8010";
    var LOST = "LOST";
    var PREFIX = "/mockjs/";
    var EMPTY_ARRAY = "EMPTY_ARRAY";
    var TYPE_NOT_EQUAL = "TYPE_NOT_EQUAL";
